...
export default function KrantzGuide() {
  return (
    <div className="space-y-8 text-foreground leading-relaxed font-serif">
      <p className="text-base sm:text-lg text-muted-foreground italic font-sans border-l-2 pl-4 py-1">
      ...
      <div className="space-y-10">
        ...
        <div className="space-y-3">
          <blockquote className="border-l-4 border-primary/50 pl-4 italic text-muted-foreground my-4">
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1 not-italic font-sans text-xs">
        ...
        <div className="space-y-3">
          <blockquote className="border-l-4 border-primary/50 pl-4 italic text-muted-foreground my-4">
            ...
            <p className="mt-2 text-xs not-italic font-sans text-muted-foreground">
        ...
        <div className="space-y-3">
          <blockquote className="border-l-4 border-primary/50 pl-4 italic text-muted-foreground my-4">
            ...
            <ul className="list-disc pl-5 my-2 space-y-1 not-italic font-sans text-xs">
              ...
              <li>Everyone else is getting invited to speak at the International Congress of Mathematicians;</li>
              <li>Everyone else is getting the plum jobs.</li>
            </ul>
            ...
            <p className="mt-2 text-xs not-italic font-sans font-semibold text-foreground">Other prestigious appointments:</p>
            <ul className="list-disc pl-5 mt-1 space-y-1 not-italic font-sans text-xs">
        ...
        <div className="space-y-3">
          <blockquote className="border-l-4 border-primary/50 pl-4 italic text-muted-foreground my-4">
            <span className="font-semibold block not-italic text-foreground mb-1">Learn good work habits:</span>
            <ul className="list-disc pl-5 space-y-1 not-italic font-sans text-xs mt-2">
              <li>When a calculation finally works out, write it up carefully, number the pages, date it, and put your name on it. File it away in an organized manner so that you can find it again.</li>
              <li>Keep a daily journal. Record in it what you have tried, what works, and what does not.</li>
              <li>Be aware of the fact that, when you do a calculation or make a discovery, it will seem as plain as day and something you will never forget. Sadly, you will. And you will forget it most surely exactly when you need it. So write it down.</li>
              <li>Often things that you tried and did not quite work out are just as valuable as things that are beautiful and glow in the dark. Keep a record of everything you try. This will be valuable both for psychological support and also as an archive of your efforts.</li>
            </ul>
          </blockquote>
        </div>
        ...
        <div className="space-y-3">
          <blockquote className="border-l-4 border-primary/50 pl-4 italic text-muted-foreground my-4">
            <span className="font-semibold block not-italic text-foreground mb-1">(On how to finish a thesis)</span>
        ...
        <div className="space-y-3">
          <blockquote className="border-l-4 border-primary/50 pl-4 italic text-muted-foreground my-4">
            <span className="font-semibold block not-italic text-foreground mb-1">(On Krantz’s advisor)</span>
