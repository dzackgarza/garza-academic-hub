      ...
      <div className="space-y-10">
        ...
        <div className="space-y-4">
          <ul className="list-disc pl-6 space-y-4 font-serif text-muted-foreground italic text-base leading-relaxed">
            ...
            <li className="pl-1">
              <strong className="text-foreground not-italic font-sans block text-sm font-semibold tracking-tight uppercase mb-1">Am I Supposed to Work All of the Time?</strong>
        ...
        <div className="space-y-4 pt-4 border-t border-border/50">
          <ul className="list-disc pl-6 space-y-4 font-serif text-muted-foreground italic text-base leading-relaxed">
            ...
            <li className="pl-1">
              ...
              <p className="mt-2 not-italic font-sans text-sm text-foreground">
