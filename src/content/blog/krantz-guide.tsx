  ...
  return (
    <div className="space-y-6">
      ...
      <ul className="list-disc pl-6 space-y-4">
        <li>
          <strong>It is of the essence that you work in a subject area, and on a thesis problem, that you like and can develop some enthusiasm for</strong>. Just as an athlete will say, “No pain, no gain.”, so a Ph.D. student in mathematics might say, “No passion, no thesis.” Just so, you also want a thesis advisor who can light a fire under you and can find a problem that will absorb you. You want a mentor who will inspire you to strive for excellence and achievement. You also want a thesis advisor with whom you can work comfortably and have a congenial relationship.
        </li>
        <li>
          <strong>Be courteous and friendly to the staff. They are the people who hold the department together</strong> and are there to help you with your work. If they do something especially nice for you, bring them cookies or flowers.
        </li>
        <li>
          I have covered the chapter and verse of how to teach, and in particular how to teach recitation sections, in the book <em>KRA1</em>. I shall not repeat those insights here. Let me just conclude by noting that you must take your teaching duties seriously. <strong>Learn your students’ names. Show them that you care. Make yourself available outside of class</strong>. Be fair and even-handed. <strong>Your department depends on you to do a good job, the math department’s reputation around campus hinges on you and the other math teachers</strong>.
        </li>
        <li>
          Am I Supposed to Work All of the Time? <strong>Definitely not</strong>. Fred Almgren, my friend and faculty mentor in graduate school, liked to say that <strong>graduate students should work four hours per day. What they did beyond that was their own business</strong>. Now one should bear in mind here that Fred had extraordinary powers of concentration. Four hours of work for Fred was like ten hours of work for anyone else.
        </li>
        <li>
          …problems on the qual, then you had better get seven or eight of them almost entirely correct. <strong>If some of the questions ask you to state theorems or definitions, then you had better get them letter perfect</strong>-with proper English and all the quantifiers in the right places. <strong>What you are learning is a discipline</strong> and your work had better manifest that discipline.
        </li>
        <li>
          ...
          <strong>As a result, what the examiners want to see on your qual is a substantial number of questions answered substantially correctly.</strong>
        </li>
        <li>
          Well, you don’t want to flunk too many quals and you don’t want to flunk them too often. Every program will give you at least two tries, and different people mature (intellectually) at different rates. The quals are not like the thesis. <strong>Qualifying exams are just a basic learning situation, one at which you have excelled all of your life. If you apply yourself and follow the advice given here (and of course follow the advice of your advisor), then you will certainly get through the quals.</strong>
        </li>
        <li>
          …the questions is terrific training. Learning to answer them is an even better regimen. And you can work out the answers together. <strong>Learning to talk about mathematics is an essential part of any graduate education</strong>.
        </li>
        <li>
        ...
        <li>
          (If) this is your first day in graduate school, I admonish you to take charge of the situation. Figure out where the math building is, go there, and <strong>introduce yourself to the Chairperson’s secretary and the Graduate secretary</strong>. If the Graduate Chairperson is around, shake hands and introduce yourself.
        </li>
        <li>
          As your program develops, <strong>keep in touch with the Graduate Director and with your thesis advisor to make sure you are making good progress</strong>. The rest should take care of itself.
        </li>
        <li>
        ...
        <li>
          ...
          <ul className="list-circle pl-6 mt-2 space-y-2">
            ...
            <li>
              ...
              <ul className="list-square pl-6 mt-1 text-xs">
            ...
            <li>
              ...
              <ul className="list-square pl-6 mt-1 text-xs">
                ...
                <li>Getting the Steele Prize.</li>
              </ul>
            </li>
          </ul>
        </li>
        <li>
          <strong>(Experience) failure and disappointment every day, and try to find ways to surmount it</strong>. For the sake of success in mathematical research, <strong>it is much more important to be able to cope with the frustration inherent in the process than it is to be “quick” or “brilliant”</strong>. To be sure, the top people are often successful, lucky, ….
        </li>
        <li>
          The only way to get the writing process going is to begin. <strong>Start small. Generate a broad outline of your thesis</strong>. The first pass can be a very vague adumbration, with just the key topics laid out. Then <strong>develop the outline by gradually adding detail</strong>. Show it to your thesis advisor just to make sure that you are headed in the right direction.
        </li>
        <li>
          Now create a very detailed outline. <strong>This draft should actually list every definition, every lemma, every theorem, and every example. Don’t write them all out</strong>. Just indicate each one with a couple of words: “the covering lemma” or “the spectral sequence argument” or “the completeness axiom”.
        </li>
        <li>
          <strong>The more you do mathematics, the more you will treasure concrete examples</strong>. I would say that <strong>most of my best work is based on just a few examples that I return to over and over again</strong>. Always remember that <strong>we learn inductively (going from the specific to the general)</strong> rather than deductively (going from the general to the specific). <strong>The deductive mode is highly appropriate for recording mathematics, but it does not work for discovering mathematics. You discover, and create, mathematics by starting small, by doing little calculations, and then working up to more substantial and meaningful calculations. The aggregate of many calculations can become an insight and that insight might turn into a conjecture. Even more effort might transmogrify that conjecture into a theorem</strong>. It is a fantastic process.
        </li>
        <li>
        ...
        <li>
          If you are stuck on what you are doing, or if you are discouraged by what you are doing, or feel that you are not making any progress, then please say so! Your professor is not a mindreader.
        </li>
        <li>
          <strong>When an experienced, senior mathematician gives you a thesis problem, then s/he is doing you a tremendous favor</strong>. Your advisor is, in effect, saying, “Here is something worth doing and it is at your level. It is a doable problem and you will get a publishable paper out of it. People are interested in this topic and you will begin to make your reputation by solving this problem. Moreover, working on this problem will lead you to other worthwhile things later on.” This is something that very few young mathematicians can do for themselves. <strong>You are not well enough read and not sufficiently networked in the mathematical community to know which problems are interesting and which are not. You certainly do not know which problems are tractable and which are not, and you do not know which problems fit your abilities. When things do not work out, you do not know what else to try, or how to adjust the problem to make it more feasible.</strong>
        </li>
        <li>
