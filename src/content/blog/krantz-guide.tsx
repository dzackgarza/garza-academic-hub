    ...
    <div className="space-y-8 text-foreground leading-relaxed font-serif">
      ...
      <ul className="space-y-10 list-none pl-0">
        ...
        <li className="space-y-3">
          ...
          <blockquote className="border-l-4 border-primary/40 pl-4 italic text-muted-foreground my-2 font-sans text-sm not-italic space-y-1">
            <p>Why is the theorem stated this way?</p>
            <p>Why is this hypothesis really needed?</p>
            <p>What happens if we change the conclusion from this to that?</p>
            <p>What would be a counterexample?</p>
            <p>Why does the proof go like this?</p>
          </blockquote>
        </li>
        ...
        <li className="space-y-3">
          ...
          <p className="text-muted-foreground text-sm font-sans pl-4 border-l border-border">
            <span className="font-semibold text-foreground">(Ask them)</span> where the graduate students hang out, what is expected of you. Where the coffee pot is. Do the same with the Department Chairperson.
          </p>
        </li>
        ...
        <li className="space-y-3">
          <blockquote className="border-l-4 border-primary/40 pl-4 italic text-muted-foreground my-2">
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1 font-sans text-xs not-italic">
        ...
        <li className="space-y-3">
          <blockquote className="border-l-4 border-primary/40 pl-4 italic text-muted-foreground my-2">
            ...
            <ul className="list-disc pl-5 my-2 space-y-1 font-sans text-xs not-italic">
          ...
          <p className="text-foreground font-sans font-semibold mt-2">Other prestigious appointments:</p>
          <blockquote className="border-l-4 border-primary/40 pl-4 italic text-muted-foreground my-2 font-sans text-xs not-italic space-y-1">
        ...
        {/* Note 28 */}
        <li className="space-y-3">
          <p className="text-foreground font-sans font-semibold mb-2">Learn good work habits.</p>
          <blockquote className="border-l-4 border-primary/40 pl-4 italic text-muted-foreground my-2 font-sans text-xs not-italic space-y-2">
            <p>
        ...
        {/* Note 30 */}
        <li className="space-y-3">
          <p className="text-foreground font-sans font-semibold mb-2">(On how to finish a thesis)</p>
          <blockquote className="border-l-4 border-primary/40 pl-4 italic text-muted-foreground my-2">
        ...
        {/* Note 34 */}
        <li className="space-y-3">
          <p className="text-foreground font-sans font-semibold mb-2">(On Krantz’s advisor)</p>
          <blockquote className="border-l-4 border-primary/40 pl-4 italic text-muted-foreground my-2">
