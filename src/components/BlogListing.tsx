        ...
        <div className="flex flex-col md:flex-row gap-3">
          ...
          <div className="flex flex-wrap gap-2 md:flex-nowrap">
            <Select value={activeCategory || "all"} onValueChange={(val) => handleCategoryChange(val === "all" ? null : val)}>
              <SelectTrigger className="w-full md:w-[170px] h-10 text-left">
            ...
            <Popover>
              <PopoverTrigger asChild>
                <Button variant="outline" className="h-10 gap-2 w-full md:w-[150px] justify-between text-left font-normal border-input">
            ...
            <Select value={activeYear ? activeYear.toString() : "all"} onValueChange={(val) => handleYearChange(val === "all" ? null : Number(val))}>
              <SelectTrigger className="w-full md:w-[120px] h-10 text-left">
