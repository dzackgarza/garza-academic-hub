...
const BlogPost = () => {
  ...
  useEffect(() => {
    ...
    import(`../../.generated/blog/${slug}.html?raw`)
      .then((mod) => {
          ...
          <div className="rounded-lg border bg-accent/25 p-6 border-dashed text-center max-w-xl mx-auto my-12 space-y-4 shadow-sm">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                This post is currently a stub. The full mathematical content, equations,
                explanations, and diagrams reside on the legacy academic site.
              </p>
            </div>
            <div className="pt-2">
              <a
        ...
        <footer className="border-t pt-6 text-xs text-muted-foreground flex flex-col sm:flex-row sm:justify-between gap-3">
          <div>
            {post.updatedDate && (
              <span>
                Last Updated:{' '}
                <span className="font-medium text-foreground">{post.updatedDate}</span>
              </span>
            )}
          </div>
          <div className="flex gap-2">
