...
test.describe("Site Integrity and Hydration Tests", () => {
  ROUTES.forEach((route) => {
    test(`Route "${route.path}" should render without console/runtime errors and hydrations should succeed`, async ({ page }) => {
      ...
      // 3. For the home page, specifically assert that the dynamic card grids are fully hydrated and display academic cards
      if (route.path === "/") {
